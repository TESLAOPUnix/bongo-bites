...
export default function Orders() {
  ...
  // Mock orders data
  const orders = [
    { id: 'ORD001', date: '2024-01-15', status: 'Delivered', total: 856, items: 3 },
    { id: 'ORD002', date: '2024-01-08', status: 'Shipped', total: 1245, items: 5 },
    { id: 'ORD003', date: '2024-01-02', status: 'Processing', total: 420, items: 2 },
    { id: 'ORD004', date: '2023-12-25', status: 'Delivered', total: 1890, items: 7 },
  ];
