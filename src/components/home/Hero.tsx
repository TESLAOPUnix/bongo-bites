...
import heroImage from '@/assets/hero-bengali-food.jpg';
  ...
  return (
    <section className="relative min-h-[85vh] md:min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Authentic Bengali food products including sweets, pickles, rice and spices"
      ...
      <div className="relative section-container py-20">
        <div className="max-w-2xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-background/10 backdrop-blur-sm border border-background/20 mb-6">
            ...
            <span className="text-sm text-background/90">Delivering Fresh Across India & Worldwide</span>
          </div>

          {/* Headline */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-background mb-6 leading-tight">
            Authentic Bengali Delights — Delivered Fresh Worldwide
          </h1>

          {/* Subheading */}
          <p className="text-lg md:text-xl text-background/80 mb-8 max-w-xl leading-relaxed">
            From traditional sweets & homemade pickles to puja essentials — experience the true taste of Bengal, 
